...
def send_email_with_report():
    send_email(
        ...
        cc=[],
        subject='[REPORT] Monthly Report - February 2025',
        html_content="""
        <html>
          <body>
            <p>Hi,</p>
            <p>Please find attached the <b>Monthly Report for February 2025</b>.</p>
            <br>
            <p>Regards,<br>Data Team</p>
          </body>
        </html>
        """,
        file_path='/opt/airflow/reports/monthly_report_feb2025.xlsx',
    )

# ── DAG ───────────────────────────────────────────────────────────────────────
with DAG(
    dag_id='3b-email-send-report',
